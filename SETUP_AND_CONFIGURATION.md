...
- `SETUP_AND_CONFIGURATION.md`: complete setup, env, token, and deployment guide.
- `docs/README.md`: repo-level documentation index.
- `docs/ARCHITECTURE.md`: cross-app architecture, ownership, and integration flow.
- `docs/APPS.md`: app and package catalog.
- `docs/ENVIRONMENT.md`: canonical env variable reference.
- `docs/FEATURE_LIFECYCLE.md`: feature planning, implementation, validation, docs, release, and deprecation flow.
- `docs/AGENT_GUIDE.md`: safe navigation and editing guidance for AI agents and human maintainers.
- `docs/monorepo-deployment.md`: concise deployment and app-boundary summary.
