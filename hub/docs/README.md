...
| [Folder Structure Architecture](folder-structure-architecture/index.md) | Defines the business documentation folder architecture and how Convex DB, domains, workflows, and governance fit together. |
...
| [Legacy](legacy/index.md) | Preserves previous flat documents as migration source material only. |

## Legacy Source Documents

The root-level legacy files remain as source material during migration. Do not add new giant root-level specifications.
...
11. [Folder Structure Architecture](folder-structure-architecture/index.md)
12. [Developer Experience](developer-experience/index.md)
13. [SDK](sdk/index.md)
14. [Legacy](legacy/index.md) only when migrating old content.
