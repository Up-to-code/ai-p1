...
Purpose: Off-market properties are hidden from marketplace visibility.

## Owns

- Off-market properties are hidden from marketplace visibility.
- Reactivation requires approved current state.
- Platforms must receive withdrawal.
...
- Keep this file focused on off market hidden only.
