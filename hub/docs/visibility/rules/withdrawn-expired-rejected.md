...
Purpose: Withdrawn, expired, rejected, and suspended records are not marketplace visible.

## Owns

- Withdrawn, expired, rejected, and suspended records are not marketplace visible.
- Rejected submissions do not update canonical data.
- Expired visibility requires renewal or new approval.
...
- Keep this file focused on withdrawn expired rejected only.
