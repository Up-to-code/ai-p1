...
Purpose: Manual hide requires permission and reason.

## Owns

- Manual hide requires permission and reason.
- Manual hide affects selected visibility types according to policy.
- Manual hide is audited.
...
- Keep this file focused on manual hide only.
