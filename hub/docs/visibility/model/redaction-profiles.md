...
Purpose: Profiles include public, partner, publisher_private, workspace, legal, and analytics.

## Owns

- Profiles include public, partner, publisher_private, workspace, legal, and analytics.
- Redaction happens before client return and before webhook queueing.
...
- Keep this file focused on redaction profiles only.
