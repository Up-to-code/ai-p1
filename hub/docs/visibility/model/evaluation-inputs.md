...
Purpose: Inputs include status, approval, platform, organization, scopes, consent, policies, Ejar, RER, manual hide, disputes, and expiry.

## Owns

- Inputs include status, approval, platform, organization, scopes, consent, policies, Ejar, RER, manual hide, disputes, and expiry.
- Missing required inputs deny marketplace visibility.
- Inputs must be auditable.
...
- Keep this file focused on evaluation inputs only.
