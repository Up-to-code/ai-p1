...
Purpose: Partner visibility is scoped by partner platform, app scopes, approval, and consent.

## Owns

- Partner visibility is scoped by partner platform, app scopes, approval, and consent.
- Partner payloads are redacted.
- Partner access can be suspended.
...
- Keep this file focused on partner only.
