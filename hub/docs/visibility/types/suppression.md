...
Purpose: Suppression visibility records why data must be hidden or withdrawn.

## Owns

- Suppression visibility records why data must be hidden or withdrawn.
- Suppression events are distributed.
- Suppression does not delete canonical history.
...
- Keep this file focused on suppression only.
