...
Purpose: Rejection records reason and evidence.

## Owns

- Rejection records reason and evidence.
- Rejected submissions do not update canonical state.
- Rejection can notify the source platform if allowed.
...
- Keep this file focused on rejection decisions only.
