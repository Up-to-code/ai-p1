...
Purpose: Rotate secrets after compromise, schedule, or admin request.

## Owns

- Rotate secrets after compromise, schedule, or admin request.
- Rotation must preserve audit trail.
...
- Keep this file focused on rotation only.
