...
Purpose: Webhook timestamp window prevents delayed replay.

## Owns

- Webhook timestamp window prevents delayed replay.
- Reject missing or old timestamp.
- Clock skew window must be explicit.
...
- Keep this file focused on timestamp validation only.
