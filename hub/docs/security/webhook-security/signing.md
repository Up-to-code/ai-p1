...
Purpose: Webhook signatures use HMAC over raw body and timestamp.

## Owns

- Webhook signatures use HMAC over raw body and timestamp.
- Receiver verifies before processing.
- Secrets are rotated with audit.
...
- Keep this file focused on signing only.
