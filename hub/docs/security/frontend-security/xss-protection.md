...
Purpose: React escaping is default.

## Owns

- React escaping is default.
- Do not render external HTML.
- Reject javascript URLs and unsafe rich text.
...
- Keep this file focused on xss protection only.
