...
Purpose: Validate content type, size, auth, idempotency, and Zod schema.

## Owns

- Validate content type, size, auth, idempotency, and Zod schema.
- Reject unknown authority-changing fields.
- Do validation before expensive work.
...
- Keep this file focused on request validation only.
