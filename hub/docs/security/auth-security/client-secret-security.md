...
Purpose: Client secrets are server-only.

## Owns

- Client secrets are server-only.
- Show once and rotate on demand.
...
- Keep this file focused on client secret security only.
