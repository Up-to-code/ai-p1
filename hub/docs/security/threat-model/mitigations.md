...
Purpose: Mitigations include PKCE, rate limiting, Zod, redaction, trusted URL validation, HMAC webhooks, and audit logs.

## Owns

- Mitigations include PKCE, rate limiting, Zod, redaction, trusted URL validation, HMAC webhooks, and audit logs.
- Controls must be enforced server-side.
...
- Keep this file focused on mitigations only.
