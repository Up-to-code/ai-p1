...
Purpose: Actors include platform admin, publisher, integration partner, auditor, legal observer, external attacker, compromised client, and internal support user.

## Owns

- Actors include platform admin, publisher, integration partner, auditor, legal observer, external attacker, compromised client, and internal support user.
- Each actor has explicit access boundaries.
- Threat model must be reviewed when roles change.
...
- Keep this file focused on actors only.
