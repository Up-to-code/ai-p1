...
Purpose: Sandbox isolates test apps and data.

## Owns

- Sandbox isolates test apps and data.
- Sandbox credentials cannot access production.
- Sandbox webhooks are clearly marked.
...
- Keep this file focused on sandbox only.
