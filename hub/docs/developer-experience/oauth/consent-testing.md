...
Purpose: Developers test consent in sandbox.

## Owns

- Developers test consent in sandbox.
- High-risk scopes must show correct copy.
- Organization context must be visible.
...
- Keep this file focused on consent testing only.
