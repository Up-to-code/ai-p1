...
Purpose: Debug delivery by event ID, status, attempts, response code, and safe error metadata.

## Owns

- Debug delivery by event ID, status, attempts, response code, and safe error metadata.
...
- Keep this file focused on delivery debugging only.
