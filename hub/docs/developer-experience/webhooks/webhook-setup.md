...
Purpose: Developers register webhook URL and signing secret handling.

## Owns

- Developers register webhook URL and signing secret handling.
- Endpoint must pass validation challenge.
...
- Keep this file focused on webhook setup only.
