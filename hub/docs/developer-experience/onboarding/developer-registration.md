...
Purpose: Developers register identity and organization in the developer project.

## Owns

- Developers register identity and organization in the developer project.
- Developer organization owns app registrations.
...
- Keep this file focused on developer registration only.
