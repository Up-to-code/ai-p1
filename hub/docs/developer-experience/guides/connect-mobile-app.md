...
Purpose: Mobile app uses public client and PKCE.

## Owns

- Mobile app uses public client and PKCE.
- No client secret.
- Uses approved scopes only.
...
- Keep this file focused on connect mobile app only.
