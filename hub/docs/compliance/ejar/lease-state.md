...
Purpose: Lease state can affect visibility.

## Owns

- Lease state can affect visibility.
- Active lease may suppress marketplace availability.
- Ejar state changes are audited.
...
- Keep this file focused on lease state only.
