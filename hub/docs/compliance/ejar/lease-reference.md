...
Purpose: Ejar lease references indicate rental contract context.

## Owns

- Ejar lease references indicate rental contract context.
- Lease references are sensitive.
...
- Keep this file focused on lease reference only.
