# Rental Visibility Impact

Purpose: Rental visibility depends on lease state, property type, and platform policy.

## Owns

- Rental visibility depends on lease state, property type, and platform policy.
- Marketplace withdrawal may be required when leased.
...
- Keep this file focused on rental visibility impact only.
