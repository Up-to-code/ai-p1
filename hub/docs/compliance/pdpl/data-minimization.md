...
Purpose: Collect only fields required for synchronization, approval, compliance, and audit.

## Owns

- Collect only fields required for synchronization, approval, compliance, and audit.
- Redact before distribution.
- Avoid copying personal data into logs.
...
- Keep this file focused on data minimization only.
