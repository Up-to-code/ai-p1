...
Purpose: SDK errors use stable codes.

## Owns

- SDK errors use stable codes.
- Expose retryable flag where useful.
- Never include raw tokens or secrets.
...
- Keep this file focused on errors only.
