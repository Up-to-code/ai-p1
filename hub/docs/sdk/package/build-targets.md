...
Purpose: Build ESM first.

## Owns

- Build ESM first.
- Support Node server and browser-safe modules separately.
- Do not bundle secrets or environment values.
...
- Keep this file focused on build targets only.
