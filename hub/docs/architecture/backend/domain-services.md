...
Purpose: Domain services are pure TypeScript modules where possible.

## Owns

- Domain services are pure TypeScript modules where possible.
- Services own business decisions like approval requirement, visibility evaluation, and conflict detection.
- Convex functions orchestrate services but do not bury policy inline.
...
- Keep this file focused on domain services only.
