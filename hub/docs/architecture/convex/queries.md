...
Purpose: Queries enforce server-side authorization.

## Owns

- Queries enforce server-side authorization.
- Queries return redacted view models.
- Queries must not return raw API keys or client secrets.
...
- Keep this file focused on queries only.
