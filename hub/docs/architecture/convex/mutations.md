...
Purpose: Mutations validate input, enforce permission, modify state, and write audit records where required.

## Owns

- Mutations validate input, enforce permission, modify state, and write audit records where required.
- Approval mutations create canonical versions.
- Visibility mutations recompute platform outcomes.
...
- Keep this file focused on mutations only.
