...
Purpose: Better Auth routes register through registerRoutesLazy.

## Owns

- Better Auth routes register through registerRoutesLazy.
- Public ingestion routes must authenticate before parsing heavy payloads.
- Webhook routes must verify signature and idempotency.
...
- Keep this file focused on http routes only.
