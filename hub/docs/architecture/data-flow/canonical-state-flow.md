...
Purpose: Approved changes create property versions.

## Owns

- Approved changes create property versions.
- Current property points to latest approved version.
- Rejected submissions remain historical evidence only.
...
- Keep this file focused on canonical state flow only.
