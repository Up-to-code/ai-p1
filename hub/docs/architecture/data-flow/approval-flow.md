...
Purpose: Approval is required for sensitive or authority-changing updates.

## Owns

- Approval is required for sensitive or authority-changing updates.
- Publisher users cannot approve their own submissions.
- Compliance review is required for restricted fields.
...
- Keep this file focused on approval flow only.
