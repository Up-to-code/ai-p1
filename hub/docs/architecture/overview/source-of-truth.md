...
Purpose: Approved canonical property versions are authoritative.

## Owns

- Approved canonical property versions are authoritative.
- External CRMs and apps submit claims, not truth.
- Rejected or pending submissions never update canonical property state.
...
- Keep this file focused on source of truth only.
