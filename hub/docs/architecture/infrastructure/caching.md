...
Purpose: Convex realtime data is primary for admin state.

## Owns

- Convex realtime data is primary for admin state.
- Do not public-cache sensitive admin records.
- Cache only static docs or safe bounded external checks.
...
- Keep this file focused on caching only.
