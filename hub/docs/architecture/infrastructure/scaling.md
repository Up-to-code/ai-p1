...
Purpose: Use Workpool for heavy async jobs.

## Owns

- Use Workpool for heavy async jobs.
- Use Aggregate for counters.
- Use pagination and stored visibility summaries for high-traffic reads.
...
- Keep this file focused on scaling only.
