...
Purpose: Canonical property changes are versioned.

## Owns

- Canonical property changes are versioned.
- Visibility policies may be versioned.
...
- Keep this file focused on versioning only.
