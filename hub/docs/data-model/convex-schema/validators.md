...
Purpose: Convex validators protect function args and schema.

## Owns

- Convex validators protect function args and schema.
- Zod protects public API and form payloads.
...
- Keep this file focused on validators only.
