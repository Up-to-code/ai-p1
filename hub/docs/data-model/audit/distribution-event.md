...
Purpose: Distribution event records outbound sync payload state.

## Owns

- Distribution event records outbound sync payload state.
- It references property version and visibility evaluation.
...
- Keep this file focused on distribution event only.
