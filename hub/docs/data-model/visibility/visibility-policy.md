...
Purpose: Visibility policy defines rules by visibility type, platform, organization, and channel.

## Owns

- Visibility policy defines rules by visibility type, platform, organization, and channel.
- Policies are versioned where needed.
...
- Keep this file focused on visibility policy only.
