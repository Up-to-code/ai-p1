...
Purpose: Use Mermaid or text diagrams for complex flow.

## Owns

- Use Mermaid or text diagrams for complex flow.
- Diagrams supplement rules.
...
- Keep this file focused on diagrams only.
