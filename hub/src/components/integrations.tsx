  ...
  return (
    <section id="resources" className="mx-auto flex max-w-7xl flex-col px-6 py-24 sm:py-32">
      ...
      <p className="mt-6 text-center text-zinc-500 dark:text-zinc-400 text-lg sm:text-xl max-w-3xl mx-auto">
        {isAr 
          ? "اربط عنان مع أدواتك المفضلة ومنصات التسويق العقاري لتبسيط سير العمل ومزامنة البيانات بشكل فوري."
          : "Connect Anan with your favorite tools and real estate marketing platforms to streamline workflows and sync data instantly."}
      </p>
