# Types / Domain / Organization

## Purpose
Shared backend types namespace reserved for cross-cutting organization contracts that cannot belong to a single domain subfolder.
