# Types / Domain / Integrations

## Purpose
Shared backend types namespace reserved for cross-cutting integrations contracts that cannot belong to a single domain subfolder.
