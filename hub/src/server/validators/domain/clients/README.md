# Validators / Domain / Clients

## Purpose
Shared backend validators namespace reserved for cross-cutting clients contracts that cannot belong to a single domain subfolder.
