# Validators / Domain / Members

## Purpose
Shared backend validators namespace reserved for cross-cutting members contracts that cannot belong to a single domain subfolder.
