# Validators / Domain / Projects

## Purpose
Shared backend validators namespace reserved for cross-cutting projects contracts that cannot belong to a single domain subfolder.
