# Validators / Domain / Properties

## Purpose
Shared backend validators namespace reserved for cross-cutting properties contracts that cannot belong to a single domain subfolder.
