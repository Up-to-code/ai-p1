# Validators / Domain / Dashboard

## Purpose
Shared backend validators namespace reserved for cross-cutting dashboard contracts that cannot belong to a single domain subfolder.
