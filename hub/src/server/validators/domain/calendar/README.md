# Validators / Domain / Calendar

## Purpose
Shared backend validators namespace reserved for cross-cutting calendar contracts that cannot belong to a single domain subfolder.
