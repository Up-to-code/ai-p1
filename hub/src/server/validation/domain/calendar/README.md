# Validation / Domain / Calendar

## Purpose
Shared backend validation namespace reserved for cross-cutting calendar contracts that cannot belong to a single domain subfolder.
