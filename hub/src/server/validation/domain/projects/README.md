# Validation / Domain / Projects

## Purpose
Shared backend validation namespace reserved for cross-cutting projects contracts that cannot belong to a single domain subfolder.
