# Validation / Domain / Properties

## Purpose
Shared backend validation namespace reserved for cross-cutting properties contracts that cannot belong to a single domain subfolder.
