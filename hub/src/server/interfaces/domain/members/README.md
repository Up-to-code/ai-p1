# Interfaces / Domain / Members

## Purpose
Shared backend interfaces namespace reserved for cross-cutting members contracts that cannot belong to a single domain subfolder.
