# Interfaces / Domain / Activity

## Purpose
Shared backend interfaces namespace reserved for cross-cutting activity contracts that cannot belong to a single domain subfolder.
