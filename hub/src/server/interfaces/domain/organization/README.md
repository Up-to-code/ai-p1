# Interfaces / Domain / Organization

## Purpose
Shared backend interfaces namespace reserved for cross-cutting organization contracts that cannot belong to a single domain subfolder.
