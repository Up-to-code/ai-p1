# Interfaces / Domain / Integrations

## Purpose
Shared backend interfaces namespace reserved for cross-cutting integrations contracts that cannot belong to a single domain subfolder.
