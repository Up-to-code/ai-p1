# Interfaces / Domain / Profile

## Purpose
Shared backend interfaces namespace reserved for cross-cutting profile contracts that cannot belong to a single domain subfolder.
