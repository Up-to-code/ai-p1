# Interfaces / Domain / Properties

## Purpose
Shared backend interfaces namespace reserved for cross-cutting properties contracts that cannot belong to a single domain subfolder.
