# Interfaces / Domain / Calendar

## Purpose
Shared backend interfaces namespace reserved for cross-cutting calendar contracts that cannot belong to a single domain subfolder.
