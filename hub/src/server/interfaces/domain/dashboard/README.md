# Interfaces / Domain / Dashboard

## Purpose
Shared backend interfaces namespace reserved for cross-cutting dashboard contracts that cannot belong to a single domain subfolder.
