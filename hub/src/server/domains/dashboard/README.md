# Dashboard Backend Domain

## Purpose
Owns backend contracts and future Hono implementation units for the dashboard bounded context.
...
When dashboard endpoints are implemented, start in routing, delegate to handlers, validate input through validators/validation, check access through access/policies, then call services.
