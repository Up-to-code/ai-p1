...
export function Sidebar() {
  ...
  return (
    <>
      <aside
        className={cn(
          "relative flex h-screen shrink-0 flex-col overflow-hidden border-e border-border bg-secondary transition-all duration-300 ease-in-out",
          isOpen ? "w-64" : "w-14",
          isRtl && "font-cairo",
        )}
      >
        ...
        <div className={cn("flex flex-col border-t border-inherit py-3", isOpen ? "gap-1 px-3" : "items-center gap-1")}>
