...
function AlertDialog({
  ...
  return (
    <AlertDialogPrimitive.Root data-slot="alert-dialog" open={open} onOpenChange={onOpenChange} {...(props as any)}>
      {children}
...
function AlertDialogOverlay({
  ...
  return (
    <div className={cn("fixed inset-0 isolate z-50", className)}>
