...
const resourceTypes = ["project", "task", "attachment", "lead", "company", "contact", "proposal", "contract", "engagement", "deliverable", "invoice", "expense", "payment"] as const satisfies readonly SearchResourceType[]
