...
export const dealApi = createResourceApi<Deal, DealFormValues, DealFormValues>({
  resourcePath: "deals",
  resourceKey: "deal",
  toPayload: dealPayloadFromForm,
});

export const createDealRequest = dealApi.create;
export const updateDealRequest = dealApi.update;
export const deleteDealRequest = dealApi.remove;
