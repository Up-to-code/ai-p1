...
import { CalendarResourceLayout } from "./calendar-resource-layout";
...
export function CalendarPageRedesigned() {
  ...
  function handleAddEvent() {
    openCreate(nextHour(currentDate), new Date(nextHour(currentDate).getTime() + 60 * 60_000));
  }

  return (
    <CalendarResourceLayout onAddEvent={handleAddEvent}>
