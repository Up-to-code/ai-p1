...
organizationRouter.post("/:organizationId/billing/checkout", handleCreateCheckout);
organizationRouter.get("/:organizationId/billing/payments/:orderId", handleGetPaymentStatus);
