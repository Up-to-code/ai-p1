...
export function assertCanChangeMemberRole(
  input: {
    ...
    nextRole: string;
    members: OrganizationMemberForPolicy[];
    roles: OrganizationRoleForPolicy[];
  },
) {
...
export function assertCanDeleteRole(
  input: {
    role: OrganizationRoleForPolicy;
    members: OrganizationMemberForPolicy[];
    invitations: OrganizationInvitationForPolicy[];
    pendingInviteLinkCount: number;
  },
) {
