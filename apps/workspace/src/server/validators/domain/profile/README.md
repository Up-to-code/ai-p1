# Validators / Domain / Profile

## Purpose
Shared backend validators namespace reserved for cross-cutting profile contracts that cannot belong to a single domain subfolder.
