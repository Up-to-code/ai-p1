# Validators / Domain / Onboarding

## Purpose
Shared backend validators namespace reserved for cross-cutting onboarding contracts that cannot belong to a single domain subfolder.
