# Validation / Domain / Integrations

## Purpose
Shared backend validation namespace reserved for cross-cutting integrations contracts that cannot belong to a single domain subfolder.
