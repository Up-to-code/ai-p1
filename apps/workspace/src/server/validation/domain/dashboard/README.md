# Validation / Domain / Dashboard

## Purpose
Shared backend validation namespace reserved for cross-cutting dashboard contracts that cannot belong to a single domain subfolder.
