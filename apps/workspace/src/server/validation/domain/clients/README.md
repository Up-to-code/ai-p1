# Validation / Domain / Clients

## Purpose
Shared backend validation namespace reserved for cross-cutting clients contracts that cannot belong to a single domain subfolder.
