# Validation / Domain / Activity

## Purpose
Shared backend validation namespace reserved for cross-cutting activity contracts that cannot belong to a single domain subfolder.
