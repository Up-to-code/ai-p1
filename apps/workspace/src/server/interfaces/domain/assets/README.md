# Interfaces / Domain / Assets

## Purpose
Shared backend interfaces namespace reserved for cross-cutting assets contracts that cannot belong to a single domain subfolder.
