# Interfaces / Domain / Projects

## Purpose
Shared backend interfaces namespace reserved for cross-cutting projects contracts that cannot belong to a single domain subfolder.
