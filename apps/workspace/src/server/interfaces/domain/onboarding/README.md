# Interfaces / Domain / Onboarding

## Purpose
Shared backend interfaces namespace reserved for cross-cutting onboarding contracts that cannot belong to a single domain subfolder.
