# Interfaces / Domain / Permissions

## Purpose
Shared backend interfaces namespace reserved for cross-cutting permissions contracts that cannot belong to a single domain subfolder.
