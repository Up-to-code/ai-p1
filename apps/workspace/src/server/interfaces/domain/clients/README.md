# Interfaces / Domain / Clients

## Purpose
Shared backend interfaces namespace reserved for cross-cutting clients contracts that cannot belong to a single domain subfolder.
