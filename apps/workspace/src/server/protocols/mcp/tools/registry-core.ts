...
export const mcpToolRegistry = [
  ...
  tool({ name: "clients_unlink_unit", title: "Unlink client from apartment", description: "Remove a client-apartment link.", resource: "client", action: "update", adapters: both }),
  tool({ name: "properties_list", title: "List apartments", description: "List active apartments.", resource: "property", action: "read", adapters: both }),
  tool({ name: "properties_get", title: "Get apartment", description: "Get one apartment.", resource: "property", action: "read", adapters: both }),
  tool({ name: "properties_open", title: "Open apartment", description: "Get apartment details plus the app URL.", resource: "property", action: "read", adapters: both }),
  tool({ name: "properties_create", title: "Create apartment", description: "Create a new apartment.", resource: "property", action: "create", adapters: both }),
  tool({ name: "properties_update", title: "Update apartment", description: "Update an apartment.", resource: "property", action: "update", adapters: both }),
  tool({ name: "properties_update_field", title: "Update one apartment field", description: "Edit a specific point in an apartment record.", resource: "property", action: "update", adapters: both }),
  tool({ name: "properties_delete", title: "Delete apartment", description: "Soft delete an apartment.", resource: "property", action: "delete", destructive: true, adapters: both }),
  ...
  tool({ name: "calendar_create", title: "Create calendar event", description: "Schedule time with client, apartment, project, or task context.", resource: "calendar", action: "create", adapters: both }),
  ...
  tool({ name: "tasks_list", title: "List tasks", description: "List client tasks.", resource: "task", action: "read", adapters: both }),
  tool({ name: "tasks_get", title: "Get task", description: "Get one client task.", resource: "task", action: "read", adapters: both }),
  tool({ name: "tasks_create", title: "Create task", description: "Create a task for a client.", resource: "task", action: "create", adapters: both }),
