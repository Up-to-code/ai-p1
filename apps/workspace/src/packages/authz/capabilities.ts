...
const organizationCapabilityChecks = {
  ...
  canReadProperties: { resource: "asset", action: "read" },
  canCreateProperties: { resource: "asset", action: "create" },
  canUpdateProperties: { resource: "asset", action: "update" },
  canDeleteProperties: { resource: "asset", action: "delete" },
