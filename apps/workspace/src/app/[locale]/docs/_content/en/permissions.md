---
title: "Choose what the agent can see and do"
label: "Permissions"
description: "Think of permissions as switches. If a switch is off, the agent cannot see that part of the company."
---
...
| **Media** | Read approved files or attach URL-based documents | `read`, `create` |
