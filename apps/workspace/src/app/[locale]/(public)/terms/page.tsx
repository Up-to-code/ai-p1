...
const copy = {
  ...
  ar: {
    ...
    blocks: [
      ...
      ["4. دقة البيانات", "تتحمل المؤسسة أو المستخدم مسؤولية صحة ودقة البيانات التي يتم إدخالها في المنصة، بما في ذلك بيانات المشاريع، الوحدات، الأسعار، المخزون، العملاء، المرفقات، والعروض.\n\nلا تتحمل كانترا مسؤولية القرارات أو التعاملات الناتجة عن بيانات غير صحيحة، غير محدثة، أو مدخلة من قبل المستخدم بشكل خاطئ."],
