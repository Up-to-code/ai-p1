...
Purpose: App registration collects name, type, URLs, requested scopes, and webhook endpoints.

## Owns

- App registration collects name, type, URLs, requested scopes, and webhook endpoints.
- Sandbox client can be created after validation.
...
- Keep this file focused on app registration only.
