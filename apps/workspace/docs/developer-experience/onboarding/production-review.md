...
Purpose: Production review checks scopes, URLs, security, webhook tests, and business legitimacy.

## Owns

- Production review checks scopes, URLs, security, webhook tests, and business legitimacy.
- Approval is by platform admin or integration security officer.
- Rejected apps keep reason.
...
- Keep this file focused on production review only.
