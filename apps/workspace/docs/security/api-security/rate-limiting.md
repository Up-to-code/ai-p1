...
Purpose: Rate-limit auth, ingestion, webhook tests, exports, and retries.

## Owns

- Rate-limit auth, ingestion, webhook tests, exports, and retries.
- Use Convex Rate Limiter for application-layer limits.
- Record abuse signals safely.
...
- Keep this file focused on rate limiting only.
