...
Purpose: Use edge/WAF for broad blocking.

## Owns

- Use edge/WAF for broad blocking.
- Use app-level allow/block lists for integrations.
- Do not trust forwarded IP headers without known proxy chain.
...
- Keep this file focused on ip blocking only.
