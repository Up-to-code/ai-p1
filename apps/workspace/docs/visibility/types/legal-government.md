...
Purpose: Legal/Government visibility is restricted.

## Owns

- Legal/Government visibility is restricted.
- Compliance officer or platform admin approval is required.
- Hidden marketplace records may remain visible to approved legal observers.
...
- Keep this file focused on legal government only.
