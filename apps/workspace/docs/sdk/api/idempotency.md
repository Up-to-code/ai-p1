...
Purpose: Inbound requests require idempotency keys.

## Owns

- Inbound requests require idempotency keys.
- Outbound distribution events use stable idempotency keys across retries.
...
- Keep this file focused on idempotency only.
