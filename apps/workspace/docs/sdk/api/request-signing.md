...
Purpose: Use request signing only where required.

## Owns

- Use request signing only where required.
- OAuth bearer token remains primary.
- Webhook signing is separate from API client auth.
...
- Keep this file focused on request signing only.
