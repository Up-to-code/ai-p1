...
Purpose: API client sends bearer token, idempotency key, and JSON payload.

## Owns

- API client sends bearer token, idempotency key, and JSON payload.
- It handles typed errors.
...
- Keep this file focused on api client only.
