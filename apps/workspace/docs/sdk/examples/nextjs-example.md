...
Purpose: Show Next.js route handler integration.

## Owns

- Show Next.js route handler integration.
- Use server-side token exchange.
- Use webhook verification helper.
...
- Keep this file focused on nextjs example only.
