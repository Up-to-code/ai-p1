...
Purpose: Webhook middleware verifies signature, timestamp, and replay.

## Owns

- Webhook middleware verifies signature, timestamp, and replay.
- Middleware exposes verified event only.
...
- Keep this file focused on middleware only.
