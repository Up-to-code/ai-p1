...
Purpose: Popup opens centered authorization window.

## Owns

- Popup opens centered authorization window.
- Fallback to redirect if blocked.
- Parent verifies postMessage origin.
...
- Keep this file focused on popup flow only.
