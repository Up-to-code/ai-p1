...
Purpose: Suppression events withdraw or hide data downstream.

## Owns

- Suppression events withdraw or hide data downstream.
- Sold and off-market marketplace records require suppression.
- Suppression is distributed to platforms that previously received visible data.
...
- Keep this file focused on suppression events only.
