...
Purpose: Distribution events represent outbound sync intent.

## Owns

- Distribution events represent outbound sync intent.
- Events reference property version and visibility evaluation.
- Events are redacted before delivery.
...
- Keep this file focused on distribution events only.
