...
Purpose: Review queue shows pending submissions, compliance flags, conflicts, and source platform.

## Owns

- Review queue shows pending submissions, compliance flags, conflicts, and source platform.
- Queue order is policy-driven.
- Review actions are permission checked.
...
- Keep this file focused on review queue only.
