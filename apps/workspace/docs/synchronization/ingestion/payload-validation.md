...
Purpose: Use Zod for public payloads.

## Owns

- Use Zod for public payloads.
- Use strict schemas.
- Reject weak statuses and unknown authority-changing fields.
...
- Keep this file focused on payload validation only.
