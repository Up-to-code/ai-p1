...
Purpose: Conflicts become reviewable submissions.

## Owns

- Conflicts become reviewable submissions.
- Do not silently overwrite canonical state.
- Conflict records must show sources and field differences.
...
- Keep this file focused on conflict resolution only.
