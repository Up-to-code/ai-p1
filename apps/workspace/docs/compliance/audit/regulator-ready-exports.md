...
Purpose: Exports are scoped and redacted.

## Owns

- Exports are scoped and redacted.
- Export requests are audited.
- Legal/Government exports require approved role and purpose.
...
- Keep this file focused on regulator ready exports only.
