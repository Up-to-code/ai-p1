...
Purpose: Personal data must be minimized.

## Owns

- Personal data must be minimized.
- Owner/contact details require strict access.
- Consent and legal basis assumptions must be documented.
...
- Keep this file focused on personal data only.
