...
Purpose: Record includes description, location, legal status, rights, obligations, and changes.

## Owns

- Record includes description, location, legal status, rights, obligations, and changes.
...
- Keep this file focused on record only.
