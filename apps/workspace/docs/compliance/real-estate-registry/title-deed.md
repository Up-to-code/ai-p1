...
Purpose: Title deed references are sensitive authority data.

## Owns

- Title deed references are sensitive authority data.
- Store reference, source, verification status, and access controls.
- Do not expose title deed data to marketplace payloads unless allowed.
...
- Keep this file focused on title deed only.
