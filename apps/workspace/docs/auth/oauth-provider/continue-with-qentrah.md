# Continue With Qentrah

Purpose: Continue with Qentrah is OAuth 2.1 Authorization Code plus PKCE.

## Owns

- Continue with Qentrah is OAuth 2.1 Authorization Code plus PKCE.
...
- Keep this file focused on continue with qentrah only.
