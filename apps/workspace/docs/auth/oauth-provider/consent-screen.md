...
Purpose: Show app name, owner organization, selected organization, requested scopes, offline access, and risk.

## Owns

- Show app name, owner organization, selected organization, requested scopes, offline access, and risk.
- Consent does not bypass approval or visibility.
- High-risk scopes must be explicit.
...
- Keep this file focused on consent screen only.
