...
Purpose: Register Better Auth HTTP routes lazily.

## Owns

- Register Better Auth HTTP routes lazily.
- Expose Next.js auth proxy at app/api/auth/[...all]/route.ts.
- Keep production CORS locked to approved origins.
...
- Keep this file focused on route registration only.
