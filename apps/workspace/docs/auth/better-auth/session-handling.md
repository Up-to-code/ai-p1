...
Purpose: Better Auth owns sessions.

## Owns

- Better Auth owns sessions.
- Convex functions use authComponent.getAuthUser.
- Organization context must be resolved server-side.
...
- Keep this file focused on session handling only.
