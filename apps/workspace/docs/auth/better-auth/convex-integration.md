...
Purpose: Register Better Auth component in convex.config.ts.

## Owns

- Register Better Auth component in convex.config.ts.
- Use getAuthConfigProvider in auth.config.ts.
- Use ConvexBetterAuthProvider in the app provider tree.
...
- Keep this file focused on convex integration only.
