...
Purpose: Install better-auth, @better-auth/oauth-provider, @convex-dev/better-auth, and convex pinned to approved versions.

## Owns

- Install better-auth, @better-auth/oauth-provider, @convex-dev/better-auth, and convex pinned to approved versions.
- Generate Better Auth schema under convex/betterAuth.
- Do not install plain Convex Auth.
...
- Keep this file focused on installation only.
