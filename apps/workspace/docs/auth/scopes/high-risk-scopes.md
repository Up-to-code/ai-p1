...
Purpose: High-risk scopes include properties.write, properties.sync, properties.visibility.write, submissions.review, webhook.manage, integrations.manage, audit.read, and mcp.tools.call.

## Owns

- High-risk scopes include properties.write, properties.sync, properties.visibility.write, submissions.review, webhook.manage, integrations.manage, audit.read, and mcp.tools.call.
- High-risk scopes require explicit consent and approval.
...
- Keep this file focused on high risk scopes only.
