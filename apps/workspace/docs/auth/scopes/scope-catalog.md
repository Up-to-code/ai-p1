...
Purpose: Required scopes include openid, profile, email, offline_access, organization.read, properties.read, properties.write, properties.sync, webhook.manage, integrations.manage, audit.read, and MCP scopes.

## Owns

- Required scopes include openid, profile, email, offline_access, organization.read, properties.read, properties.write, properties.sync, webhook.manage, integrations.manage, audit.read, and MCP scopes.
- Every scope has risk level and approval policy.
...
- Keep this file focused on scope catalog only.
