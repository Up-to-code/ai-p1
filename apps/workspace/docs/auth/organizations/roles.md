...
Purpose: Roles include owner, admin, integration_admin, publisher_manager, publisher_editor, reviewer, compliance_officer, auditor, legal_observer, workspace_viewer, and support_operator.

## Owns

- Roles include owner, admin, integration_admin, publisher_manager, publisher_editor, reviewer, compliance_officer, auditor, legal_observer, workspace_viewer, and support_operator.
- Roles describe who the member is inside the organization.
- Roles do not replace resource checks.
...
- Keep this file focused on roles only.
