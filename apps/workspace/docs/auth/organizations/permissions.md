...
Purpose: Permissions describe allowed actions.

## Owns

- Permissions describe allowed actions.
- Scopes map to permissions at the resource server.
- Publisher self-approval remains forbidden.
...
- Keep this file focused on permissions only.
