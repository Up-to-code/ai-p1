...
Purpose: Use official sources for regulations and package docs.

## Owns

- Use official sources for regulations and package docs.
- Mark inference separately from sourced facts.
- No social media for regulatory claims.
...
- Keep this file focused on references only.
