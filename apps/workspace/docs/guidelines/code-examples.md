...
Purpose: Examples include file path and TypeScript where relevant.

## Owns

- Examples include file path and TypeScript where relevant.
- No secrets or personal data.
- Do not show unsafe token storage.
...
- Keep this file focused on code examples only.
