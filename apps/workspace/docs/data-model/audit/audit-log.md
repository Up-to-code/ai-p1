...
Purpose: Audit log records sensitive actions.

## Owns

- Audit log records sensitive actions.
- Audit data is append-only in intent.
- Reads and exports are controlled.
...
- Keep this file focused on audit log only.
