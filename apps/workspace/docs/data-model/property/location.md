...
Purpose: Location includes city, district, address, coordinates, National Address where available, and geospatial confidence.

## Owns

- Location includes city, district, address, coordinates, National Address where available, and geospatial confidence.
- Location affects duplicate detection.
- Location display is visibility-scoped.
...
- Keep this file focused on location only.
