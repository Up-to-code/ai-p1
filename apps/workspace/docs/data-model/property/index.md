...
Purpose: Explains property identity, location, lifecycle, identifiers, and ownership references.

## Scope

This folder owns small, focused documentation files for property.
...
| File | Purpose |
| --- | --- |
| [Identity](identity.md) | Property identity uses workspace ID plus identifiers where available. |
...
| [Identifiers](saudi-identifiers.md) | Identifiers include RER property number, title deed references, Ejar reference, Wafi/off-plan references, plan, plot, block, and National Address. |
| [Ownership References](ownership-references.md) | Ownership references are restricted. |

## Read Order

1. [Identity](identity.md)
2. [Location](location.md)
3. [Lifecycle Status](lifecycle-status.md)
4. [Identifiers](saudi-identifiers.md)
5. [Ownership References](ownership-references.md)
