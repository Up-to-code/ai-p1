...
Purpose: Visibility evaluation stores computed result and reasons.

## Owns

- Visibility evaluation stores computed result and reasons.
- Evaluations feed distribution.
- Evaluations are recomputed after relevant changes.
...
- Keep this file focused on visibility evaluation only.
