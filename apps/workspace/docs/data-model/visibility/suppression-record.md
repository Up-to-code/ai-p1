...
Purpose: Suppression record stores hidden reason and platform impact.

## Owns

- Suppression record stores hidden reason and platform impact.
- Suppression does not delete canonical data.
...
- Keep this file focused on suppression record only.
