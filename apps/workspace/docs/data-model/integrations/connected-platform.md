...
Purpose: Connected platform represents external CRM, app, marketplace, workspace, or partner system.

## Owns

- Connected platform represents external CRM, app, marketplace, workspace, or partner system.
- Platform status affects distribution.
- Platform scopes are approved.
...
- Keep this file focused on connected platform only.
