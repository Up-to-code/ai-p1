...
Purpose: Webhook endpoint stores URL, status, signing configuration reference, last test, and approval state.

## Owns

- Webhook endpoint stores URL, status, signing configuration reference, last test, and approval state.
- Endpoint validation is mandatory.
- Deliveries are audited.
...
- Keep this file focused on webhook endpoint only.
