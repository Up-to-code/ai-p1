...
Purpose: Membership profile projects user role by organization.

## Owns

- Membership profile projects user role by organization.
- Better Auth remains source.
- Stale projection denies sensitive access.
...
- Keep this file focused on membership profile only.
