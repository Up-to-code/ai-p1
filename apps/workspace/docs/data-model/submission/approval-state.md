...
Purpose: Approval state records reviewer, decision, reason, timestamp, and affected canonical version.

## Owns

- Approval state records reviewer, decision, reason, timestamp, and affected canonical version.
- Approval is permission checked.
- Approval can trigger sync.
...
- Keep this file focused on approval state only.
