...
Purpose: Submission records capture source, payload, normalized output, validation state, and review state.

## Owns

- Submission records capture source, payload, normalized output, validation state, and review state.
- Submissions are claims.
- Submissions preserve evidence.
...
- Keep this file focused on submission record only.
