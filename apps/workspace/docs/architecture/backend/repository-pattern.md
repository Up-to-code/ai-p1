...
Purpose: Repositories isolate table access patterns.

## Owns

- Repositories isolate table access patterns.
- Domain logic must not scatter repeated Convex queries across unrelated files.
- Repositories never bypass authorization.
...
- Keep this file focused on repository pattern only.
