...
Purpose: Queries read and redact data.

## Owns

- Queries read and redact data.
- Mutations change state and audit sensitive transitions.
- Actions call external services and must be idempotent when retried.
...
- Keep this file focused on convex functions only.
