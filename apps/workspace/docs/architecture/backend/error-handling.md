...
Purpose: Errors use stable codes.

## Owns

- Errors use stable codes.
- Do not expose secrets, raw tokens, or personal data in messages.
- Retryable and non-retryable errors must be distinguishable.
...
- Keep this file focused on error handling only.
