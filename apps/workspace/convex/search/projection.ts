...
export async function writeSearchProjection(ctx: MutationCtx, projection: SearchProjection) {
  ...
  const value = { ...projection, version, keywords: [...new Set(projection.keywords)], principalKeys: [...new Set(projection.principalKeys)], spaceIds: [...new Set(projection.spaceIds)], projectIds: [...new Set(projection.projectIds)] };
