...
> = {
  ar: {
    advisor: { brand: "كانترا", suffix: "المستشار" },
    search: { brand: "كانترا", suffix: "البحث" },
    compare: { brand: "كانترا", suffix: "المقارنة" },
    save: { brand: "كانترا", suffix: "الحفظ" },
    finance: { brand: "كانترا", suffix: "التمويل" },
    legal: { brand: "كانترا", suffix: "القانوني" },
    mixed: { brand: "كانترا", suffix: "البحث والتمويل" },
  },
  en: {
    advisor: { brand: "QENTRAH", suffix: "ADVISOR" },
    search: { brand: "QENTRAH", suffix: "SEARCH" },
    compare: { brand: "QENTRAH", suffix: "COMPARE" },
    save: { brand: "QENTRAH", suffix: "SAVE" },
    finance: { brand: "QENTRAH", suffix: "FINANCE" },
    legal: { brand: "QENTRAH", suffix: "LEGAL" },
    mixed: { brand: "QENTRAH", suffix: "SEARCH + FINANCE" },
  },
  fr: {
    advisor: { brand: "QENTRAH", suffix: "CONSEIL" },
    search: { brand: "QENTRAH", suffix: "RECHERCHE" },
    compare: { brand: "QENTRAH", suffix: "COMPARAISON" },
    save: { brand: "QENTRAH", suffix: "ENREGISTREMENT" },
    finance: { brand: "QENTRAH", suffix: "FINANCEMENT" },
    legal: { brand: "QENTRAH", suffix: "JURIDIQUE" },
    mixed: { brand: "QENTRAH", suffix: "RECHERCHE + FINANCEMENT" },
  },
};
