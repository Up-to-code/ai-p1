...
export const errorStates: ErrorStateDefinition[] = [
  {
    ...
    signal: "Draft notes stay local until the Workspace API is reachable.",
  ...
  },
  {
    ...
    signal: "We can restart the workspace and keep your account state intact.",
  ...
  },
  {
    ...
    code: "NET",
    title: "Qentrah cannot reach the AI service.",
    body: "Your device appears offline or the backend is unreachable. Cached research remains visible.",
    signal: "Favorite chats can stay on screen while sync waits in the background.",
    technicalNote: "Use this for network timeouts, Workspace API disconnects, and airplane-mode moments.",
    Icon: CloudOff,
  },
  {
    kind: "maintenance",
