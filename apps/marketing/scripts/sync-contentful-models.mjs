...
const assets = (id, name, required = true, validations = []) => ({ id, name, type: "Array", required, localized: false, validations, items: { type: "Link", linkType: "Asset" } });
...
const models = [
  ...
  { id: "qentrahLandingHero", name: "Qentrah · Home hero", displayField: "internalName", fields: [symbol("internalName", "Internal name"), symbol("eyebrow", "Eyebrow"), symbol("title", "Primary headline", false), symbol("primaryActionLabel", "Primary action label"), entries("benefits", "Benefit rows", ["qentrahLandingTextCard"], false), text("note", "Supporting note", false), symbol("modulesLabel", "Modules label", false), symbols("modules", "Module labels", false), symbol("imageAlt", "Hero image alt text", false), asset("image", "Hero image")] },
  { id: "qentrahPlatformStoryBlock", name: "Qentrah · Platform story", displayField: "internalName", fields: [symbol("internalName", "Internal name"), symbol("contextTitle", "Context section title"), text("contextBody", "Context section body"), symbol("contextImageAlt", "Context image alt text"), asset("contextImage", "Context image"), symbol("platformTitle", "Platform section title"), text("platformBody", "Platform section body"), symbol("agentTitle", "Agent section title"), text("agentBody", "Agent section body"), symbol("primaryActionLabel", "Primary action label"), symbol("secondaryActionLabel", "Secondary action label"), entries("agentCapabilities", "Agent capability cards", ["qentrahLandingTextCard"], true, sizeRange(5, 6)), assets("agentImages", "Agent capability card images", false, exactSize(3))] },
  { id: "qentrahAiOutcomesBlock", name: "Qentrah · AI solutions", displayField: "internalName", fields: [symbol("internalName", "Internal name"), symbol("solutionsTitle", "Solutions title"), text("solutionsBody", "Solutions body"), symbol("solutionKicker", "Solution eyebrow"), symbols("solutionBullets", "Solution bullet points"), asset("solutionImage", "Solution image"), symbol("exploreLabel", "Explore action label")] },
  { id: "qentrahTrustBlock", name: "Qentrah · Trust", displayField: "internalName", fields: [symbol("internalName", "Internal name"), symbol("kicker", "Eyebrow"), symbol("title", "Title"), text("body", "Body"), entries("items", "Trust cards", ["qentrahLandingTextCard"], true, exactSize(3)), assets("images", "Trust card images", true, exactSize(3)), text("assurance", "Assurance statement"), symbols("marks", "Trust marks", true, exactSize(2))] },
  ...
  { id: "qentrahHomeSupportBlock", name: "Qentrah · Home support", displayField: "internalName", fields: [symbol("internalName", "Internal name"), symbols("workspaceCells", "Workspace cell labels", true, exactSize(32)), symbols("solutionTabs", "Solution tab labels", true, exactSize(5)), symbol("showcaseImageAlt", "Showcase image alt text"), entry("logoCloud", "Logo cloud", ["qentrahLogoCloudBlock"]), entry("faq", "Home FAQ", ["qentrahFaqBlock"])] },
