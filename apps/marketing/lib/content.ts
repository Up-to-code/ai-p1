...
const workspaceLegal = {
  en: {
    ...
    privacy: [
      block("1. Introduction", "Welcome to Qentrah. Your privacy and data security are critical to us. This Privacy Policy explains how Qentrah collects, uses, and protects your information when you use our AI-powered workspace and client operations platform."),
      block("2. Data Collection and Usage", "We collect information necessary to provide and improve the Qentrah service, including account details, workspace data (Clients, Opportunities, Projects, Tasks), and usage metrics. Your data is used exclusively to operate the platform, provide AI-assisted insights within your workspace, and enhance your user experience."),
      block("3. AI and Data Processing", "Qentrah utilizes AI to operate your workspace. We ensure that data processed by our AI models is handled securely and is used solely to provide features to your specific workspace. We do not use your proprietary client data to train public models."),
      block("4. Data Security", "We implement industry-standard security measures to protect your client data and workspace information from unauthorized access, alteration, or disclosure."),
      block("5. Cookies and Tracking", "Qentrah uses cookies and similar technologies to maintain user sessions, remember preferences, and analyze platform performance. You can control cookie preferences through your browser settings."),
      block("6. Your Rights", "You have the right to access, correct, or delete your personal and workspace data at any time. If you wish to exercise these rights or have questions about how Qentrah handles your data, please contact me directly at hello@qentrah.com."),
      block("7. Changes to This Policy", "As Qentrah evolves, this Privacy Policy may be updated. We will notify you of any significant changes via email or an in-app notification."),
    ],
    terms: [
      ...
      block("2. Platform Description", "The platform provides an AI-powered workspace, client operations, and project management tools for authorized agencies and professional service teams."),
      ...
      block("4. Data Accuracy", "Organizations are responsible for the accuracy of project, task, client, and operational data submitted to the platform."),
  ...
  ar: {
    ...
    privacy: [
      block("1. المقدمة", ["توضح هذه السياسة كيف تقوم كانترا بجمع البيانات الشخصية واستخدامها وحمايتها عند استخدام المنصة أو التواصل معنا أو الاستفادة من خدمات مساحة العمل للوكالات.", "باستخدامك للمنصة، فإنك تقرّ بأنك قرأت هذه السياسة وفهمت طريقة تعامل كانترا مع بياناتك."]),
    ...
    terms: [
      ...
      block("2. وصف المنصة", "توفر كانترا مساحة عمل مدعومة بالذكاء الاصطناعي تساعد الوكالات، وفرق الخدمات المهنية على إدارة المشاريع، المهام، العملاء، البيانات، والتكاملات من خلال بيئة تشغيل موحدة.\n\nتسعى المنصة إلى تحسين كفاءة التشغيل، توحيد البيانات، وتسريع متابعة الفرص، ولا تُعد بديلاً عن التحقق المهني أو النظامي من المعلومات قبل اتخاذ القرارات التجارية أو التعاقدية."),
    ...
    legal: [
      block("1. معلومات الشركة", ["تُدار منصة كانترا بواسطة شركة إتجاه التقنية، وهي منصة مساحة عمل تقدم حلولًا تشغيلية للوكالات، وفرق الخدمات المهنية.", ["المقر: جدة، المملكة العربية السعودية", "الرقم الضريبي: 310425795900003"]]),
