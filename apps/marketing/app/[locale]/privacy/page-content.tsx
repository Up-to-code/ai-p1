...
const copy = {
  en: {
    ...
    blocks: [
      ["1. Introduction", "Qentrah Workspace operates a workspace workspace and data synchronization platform for teams in Saudi Arabia. This policy explains how we collect, use, disclose, and protect information when you use the platform."],
      ...
      ["3. How We Use Information", "We use information to verify organizations, manage accounts, support workspace features, synchronize asset data, operate integrations, provide support, and meet applicable Saudi regulatory and compliance requirements."],
  ...
  ar: {
    ...
    blocks: [
      ["1. المقدمة", ["توضح هذه السياسة كيف تقوم كانترا بجمع البيانات الشخصية واستخدامها وحمايتها عند استخدام المنصة أو التواصل معنا أو الاستفادة من خدمات مساحة العمل.", "باستخدامك للمنصة، فإنك تقرّ بأنك قرأت هذه السياسة وفهمت طريقة تعامل كانترا مع بياناتك."]],
      ["2. المعلومات التي نجمعها", ["قد نجمع المعلومات التي تقدمها لنا مباشرة، مثل:", ["الاسم", "البريد الإلكتروني", "رقم الجوال", "اسم الشركة أو الفريق", "معلومات الحساب", "بيانات المشاريع والأصول والعملاء التي يتم إدخالها في مساحة العمل", "الرسائل والاستفسارات المرسلة عبر نماذج التواصل"], "كما قد نجمع بيانات تقنية عند استخدام المنصة، مثل عنوان IP، نوع المتصفح، الجهاز المستخدم، وسجلات الاستخدام لتحسين الأداء والأمان."]],
      ["3. كيف نستخدم المعلومات", ["نستخدم البيانات للأغراض التالية:", ["إنشاء الحسابات وإدارة مساحات العمل", "تشغيل خدمات المنصة وإدارة المشاريع والأصول والعملاء", "تحسين تجربة المستخدم وتطوير خصائص المنصة", "تقديم الدعم الفني والتشغيلي", "إرسال التنبيهات والتحديثات المرتبطة بالخدمة", "تعزيز الأمان ومنع الاستخدام غير المصرح به", "الالتزام بالمتطلبات النظامية والتنظيمية عند الحاجة"]]],
