...
import { getBlogPost, getBlogPosts } from "@/lib/payload-api";
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  try {
    ...
    return { title: isAr ? "المقالة غير موجودة" : "Post not found" };
  }
}
...
export default async function BlogPostPage({ params }: Props) {
  ...
  let post;
  try {
    post = await getBlogPost(slug, locale as "en" | "ar");
  } catch {
    notFound();
  }
