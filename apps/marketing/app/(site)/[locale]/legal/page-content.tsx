...
function ar() {
  ...
  return {
    ...
    blocks: [
      [
        "2. الامتثال التنظيمي",
        "تعمل كانترا وفق الأنظمة المعمول بها في جمهورية مصر العربية، بما يشمل قانون حماية البيانات الشخصية (القانون رقم 151 لسنة 2020) وقانون التوقيع الإلكتروني (القانون رقم 15 لسنة 2004). يتحمل المستخدم مسؤولية التأكد من أن استخدامه للمنصة يتوافق مع جميع الأنظمة المعمول بها في نطاقه القانوني.",
      ],
      [
        "3. الملكية الفكرية",
        "جميع العلامات التجارية، الشعارات، التصاميم، النصوص، البرمجيات، الواجهات، قواعد البيانات، والمحتويات المعروضة على المنصة مملوكة لـ كانترا أو مرخّصة لها. جميع الحقوق محفوظة.\n\nيحظر نسخ أو إعادة استخدام أو توزيع أو تعديل أو إنشاء أعمال مشتقة من أي جزء من المنصة دون موافقة خطية مسبقة. أي استخدام غير مصرح به قد يؤدي إلى اتخاذ إجراءات قانونية.",
      ],
      [
        "4. الاستخدام المسموح",
        "يجب استخدام المنصة للأغراض المشروعة فقط ووفقًا لهذه الشروط. يُحظر استخدام المنصة في أي نشاط احتيالي أو مسيء أو ضار.\n\nتشمل الأنشطة المحظورة على سبيل المثال لا الحصر: الوصول غير المصرح به للأنظمة، استخراج البيانات، إدخال برمجيات خبيثة، التدخل في تشغيل المنصة، وانتحال شخصية الآخرين.",
      ],
      [
        "5. دقة المعلومات",
        "تعتمد المنصة على البيانات التي يتم إدخالها أو تحديثها من قبل المستخدمين أو الجهات المصرح لها داخل مساحة العمل. لا تقوم كانترا بالتحقق المستقل من دقة أو اكتمال أو قانونية البيانات المدخلة من قبل المستخدمين.\n\nلذلك، يتحمل المستخدم أو الجهة المالكة للحساب المسؤولية الكاملة عن دقة بيانات المشاريع، الأصول، الأسعار، العملاء، والمرفقات المدخلة في المنصة. لا تتحمل كانترا أي مسؤولية عن القرارات أو التعاملات الناتجة عن بيانات غير صحيحة أو غير محدثة.",
      ],
      [
        "6. الخدمات والروابط الخارجية",
        "قد تتضمن المنصة روابط لمواقع أو خدمات خارجية، أو تتيح التكامل مع أدوات طرف ثالث. لا تؤيد كانترا هذه الخدمات الخارجية ولا تتحكم فيها ولا تتحمل أي مسؤولية عن محتواها أو ممارسات الخصوصية أو أمانها.\n\nأي تعامل مع خدمات خارجية يتم بينك وبين الطرف الثالث فقط، وتخلى كانترا مسؤوليتها بالكامل عن أي أضرار ناتجة عن هذه التعاملات.",
      ],
      [
        "7. حدود المسؤولية",
        "بأقصى حد يسمح به القانون، لا تتحمل كانترا ومؤسسوها وموظفوها والجهات المرتبطة بها أي مسؤولية عن أي أضرار مباشرة أو غير مباشرة أو عرضية أو تبعية أو تأديبية تنشأ عن استخدامك للمنصة.\n\nيشمل ذلك على سبيل المثال لا الحصر: فقدان البيانات، خسارة الأرباح، انقطاع الخدمة، الأخطاء في المحتوى، والأضرار الناتجة عن الوصول غير المصرح به إلى بياناتك أو تعديلها.",
      ],
      [
        "8. إخلاء المسؤولية عن الضمانات",
        "تُقدم المنصة وجميع المحتويات المتاحة من خلالها \"كما هي\" و\"كما تتوفر\" دون أي ضمانات من أي نوع، سواء كانت صريحة أو ضمنية.\n\nلا تضمن كانترا أن المنصة ستكون خالية من الانقطاعات أو الأخطاء أو الفيروسات أو المكونات الضارة الأخرى. تخلوا كانترا صراحةً من جميع الضمانات، بما في ذلك الضمانات الضمنية المتعلقة بالقابلية للتسويق والملاءمة لغرض معين وعدم التعدي.",
      ],
      [
        "9. حماية البيانات",
        "تتعامل كانترا مع البيانات الشخصية وفق سياسة الخصوصية المعتمدة ووفقًا لأنظمة حماية البيانات الشخصية المعمول بها، بما في ذلك قانون حماية البيانات الشخصية المصري (القانون رقم 151 لسنة 2020).\n\nيُرجى مراجعة سياسة الخصوصية للحصول على معلومات مفصلة حول كيفية جمع بياناتك واستخدامها وتخزينها وحمايتها.",
      ],
      [
        "10. تسوية النزاعات والقانون الحاكم",
        "تخضع هذه الشروط وأي نزاع متعلق باستخدام المنصة للأنظمة المعمول بها في جمهورية مصر العربية.\n\nيسعى الطرفان أولاً إلى حل أي نزاع وديًا من خلال مفاوضات بحسن نية. إذا تعذر حل النزاع خلال 30 يومًا، يُحال إلى الجهات القضائية المختصة في القاهرة، جمهورية مصر العربية، والتي تنفرد بالاختصاص القضائي.",
      ],
      [
        "11. التواصل القانوني",
        `للاستفسارات أو الطلبات القانونية، يُرجى التواصل عبر:\n\nlegal@${rootDomain}\n\nيجب إرسال جميع المراسلات القانونية كتابيًا إلى العنوان المسجل للشركة.`,
      ],
    ],
  };
}
