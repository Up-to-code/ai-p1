  ...
  en: {
    ...
    blocks: [
      ...
      [
        ...
        "The platform provides workspace, data management, synchronization, and integration tools for authorized teams, operators, and partners.",
      ],
      [
      ...
      [
        "4. Data Accuracy",
        "Organizations are responsible for the accuracy of project, asset, client, and operational data submitted to the platform.",
      ],
      [
        "5. Integrations",
      ...
      [
        "7. Governing Law",
        "These Terms are governed by applicable law. Any disputes will be resolved according to the jurisdiction specified in your service agreement.",
      ],
    ],
  },
  ar: {
    ...
    blocks: [
      ...
      [
        "4. دقة البيانات",
        "تتحمل المؤسسة أو المستخدم مسؤولية صحة ودقة البيانات التي يتم إدخالها في المنصة، بما في ذلك بيانات المشاريع، الأصول، الأسعار، العملاء، المرفقات، والعروض.\n\nلا تتحمل كانترا مسؤولية القرارات أو التعاملات الناتجة عن بيانات غير صحيحة، غير محدثة، أو مدخلة من قبل المستخدم بشكل خاطئ.",
      ],
      [
