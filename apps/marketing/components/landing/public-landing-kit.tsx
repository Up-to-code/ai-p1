  ...
  return (
    <section
      ...
      className={cn(
        ...
        tone === "default" && "bg-[var(--q-card)] text-foreground dark:bg-background",
        tone === "muted" && "bg-zinc-50/80 text-foreground dark:bg-zinc-950/50",
        tone === "inverse" && "bg-[var(--q-text-primary)] text-[var(--q-text-primary)] dark:bg-white dark:text-zinc-950",
        className,
      )}
    >
  ...
  return (
    <Link
      ...
      className={cn(
        ...
        variant === "primary" && "bg-[var(--q-text-primary)] text-[var(--q-text-primary)] hover:bg-zinc-800 dark:bg-white dark:text-zinc-950 dark:hover:bg-zinc-200",
