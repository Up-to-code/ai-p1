    ...
    <section className="px-6 py-20 md:py-32 bg-[var(--q-bg-very-dark)] dark:bg-[var(--q-bg-very-dark)] border-t border-[var(--q-border)]">
      <div className="mx-auto max-w-5xl text-center flex flex-col items-center">
        <div className="inline-flex items-center justify-center gap-2 rounded-full bg-[var(--q-accent-muted)] px-4 py-1.5 mb-8 transition-colors hover:bg-[var(--q-accent)] cursor-default group">
          <span className="w-2 h-2 rounded-full bg-[var(--q-accent)] animate-pulse group-hover:bg-background" />
          <span className="text-[11px] font-bold uppercase tracking-[0.2em] text-[var(--q-accent)] group-hover:text-background">
            {t("eyebrow")}
          </span>
        </div>
