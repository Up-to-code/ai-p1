...
Organization authorization expires after 14 days. Workspace rejects expired connections with `connection_expired`. Send the workspace admin through Authorize with Qentrah again to reconnect.
