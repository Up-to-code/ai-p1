...
export const partnerMcpToolDefinitions = [
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        appCategory: { type: "string", enum: ["brokerage", "developer", "crm", "marketing", "operations", "other"] },
        integrationMode: { type: "string", enum: ["integrate", "debug", "sandbox", "workspace", "production"] },
      ...
      required: ["name", "publisherName", "description", "appCategory", "integrationMode", "homepageUrl", "clientType", "redirectUris", "allowedScopes"],
  ...
  },
  {
    ...
    inputSchema: {
      ...
      required: ["appId", "name", "publisherName", "description", "appCategory", "integrationMode", "homepageUrl", "redirectUris", "allowedScopes"],
      additionalProperties: false,
    },
  },
  {
