...
Purpose: Integration log records inbound and outbound integration events.

## Owns

- Integration log records inbound and outbound integration events.
- It supports debugging without secrets.
- Logs include request IDs and platform IDs.
...
- Keep this file focused on integration log only.
