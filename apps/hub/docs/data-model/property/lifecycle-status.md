...
Purpose: Lifecycle statuses include draft, pending, approved, active, sold, off_market, withdrawn, leased, expired, rejected, suspended, disputed, and hidden.

## Owns

- Lifecycle statuses include draft, pending, approved, active, sold, off_market, withdrawn, leased, expired, rejected, suspended, disputed, and hidden.
- Status drives visibility.
- Status changes are versioned.
...
- Keep this file focused on lifecycle status only.
