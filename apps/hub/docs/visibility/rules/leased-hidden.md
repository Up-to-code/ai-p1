...
Purpose: Leased state can require marketplace withdrawal depending on property and lease policy.

## Owns

- Leased state can require marketplace withdrawal depending on property and lease policy.
- Ejar references are sensitive.
- Leased does not erase property history.
...
- Keep this file focused on leased hidden only.
