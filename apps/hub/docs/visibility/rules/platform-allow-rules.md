...
Purpose: Platforms receive only approved scopes and visibility types.

## Owns

- Platforms receive only approved scopes and visibility types.
- Platform suspension stops distribution.
- Per-platform summaries are stored.
...
- Keep this file focused on platform allow rules only.
