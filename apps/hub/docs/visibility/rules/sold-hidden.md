...
Purpose: Sold properties are hidden from marketplace visibility.

## Owns

- Sold properties are hidden from marketplace visibility.
- CRM and legal visibility may remain when authorized.
- Suppression event is mandatory after approval.
...
- Keep this file focused on sold hidden only.
