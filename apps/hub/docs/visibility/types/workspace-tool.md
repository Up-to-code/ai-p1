...
Purpose: Workspace visibility supports internal operational tools.

## Owns

- Workspace visibility supports internal operational tools.
- Workspace access is role and organization scoped.
- Draft or suppressed records require explicit permission.
...
- Keep this file focused on workspace tool only.
