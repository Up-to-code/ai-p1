...
Purpose: Marketplace visibility is public listing visibility.

## Owns

- Marketplace visibility is public listing visibility.
- Sold, off-market, withdrawn, expired, rejected, suspended, disputed, and manually hidden records are not visible.
- Only approved current data can be visible.
...
- Keep this file focused on marketplace only.
