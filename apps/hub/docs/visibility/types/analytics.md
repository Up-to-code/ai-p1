...
Purpose: Analytics visibility uses aggregate or redacted data.

## Owns

- Analytics visibility uses aggregate or redacted data.
- Do not expose raw personal or legal data.
- Analytics does not become a separate product scope.
...
- Keep this file focused on analytics only.
