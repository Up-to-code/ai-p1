...
Purpose: Developer apps register redirect URIs, allowed origins, webhook URLs, and requested scopes.

## Owns

- Developer apps register redirect URIs, allowed origins, webhook URLs, and requested scopes.
- Production approval is required.
- Client secrets are shown once.
...
- Keep this file focused on client registration only.
