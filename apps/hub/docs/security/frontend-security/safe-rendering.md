...
Purpose: Render submitted data as text.

## Owns

- Render submitted data as text.
- Use ShadCN components for structured UI.
- Never use dangerouslySetInnerHTML for external property data.
...
- Keep this file focused on safe rendering only.
