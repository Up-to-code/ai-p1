...
Purpose: API keys are hashed, scoped, revocable, and audited.

## Owns

- API keys are hashed, scoped, revocable, and audited.
- Raw value is shown once.
- OAuth is preferred.
...
- Keep this file focused on api key security only.
