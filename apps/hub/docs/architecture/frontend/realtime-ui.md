...
Purpose: Use Convex reactive queries for submissions, properties, sync events, and audit state.

## Owns

- Use Convex reactive queries for submissions, properties, sync events, and audit state.
- Render loading, empty, error, and permission-denied states explicitly.
- Do not poll Convex data through generic REST endpoints.
...
- Keep this file focused on realtime ui only.
