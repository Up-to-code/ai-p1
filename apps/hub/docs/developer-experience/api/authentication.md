...
Purpose: APIs use OAuth bearer token or approved API key.

## Owns

- APIs use OAuth bearer token or approved API key.
- OAuth preferred.
- Every request is organization scoped where needed.
...
- Keep this file focused on authentication only.
