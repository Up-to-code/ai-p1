# Connect Partner Platform

Purpose: Partner platform registers OAuth client and webhook endpoints.

## Owns

- Partner platform registers OAuth client and webhook endpoints.
- Platform distribution is scoped.
- Partner must process idempotent events.
...
- Keep this file focused on connect partner platform only.
