# Integrations Backend Domain

## Purpose
Owns backend contracts and future Hono implementation units for the integrations bounded context.
...
When integrations endpoints are implemented, start in routing, delegate to handlers, validate input through validators/validation, check access through access/policies, then call services.
