# Permissions Backend Domain

## Purpose
Owns backend contracts and future Hono implementation units for the permissions bounded context.
...
When permissions endpoints are implemented, start in routing, delegate to handlers, validate input through validators/validation, check access through access/policies, then call services.
