# Types / Domain / Permissions

## Purpose
Shared backend types namespace reserved for cross-cutting permissions contracts that cannot belong to a single domain subfolder.
