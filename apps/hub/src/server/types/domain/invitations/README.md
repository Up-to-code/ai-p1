# Types / Domain / Invitations

## Purpose
Shared backend types namespace reserved for cross-cutting invitations contracts that cannot belong to a single domain subfolder.
