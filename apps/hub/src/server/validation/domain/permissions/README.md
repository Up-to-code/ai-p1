# Validation / Domain / Permissions

## Purpose
Shared backend validation namespace reserved for cross-cutting permissions contracts that cannot belong to a single domain subfolder.
