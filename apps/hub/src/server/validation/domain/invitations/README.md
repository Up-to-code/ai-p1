# Validation / Domain / Invitations

## Purpose
Shared backend validation namespace reserved for cross-cutting invitations contracts that cannot belong to a single domain subfolder.
