# Validation / Domain / Profile

## Purpose
Shared backend validation namespace reserved for cross-cutting profile contracts that cannot belong to a single domain subfolder.
