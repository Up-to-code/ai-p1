# Validation / Domain / Members

## Purpose
Shared backend validation namespace reserved for cross-cutting members contracts that cannot belong to a single domain subfolder.
