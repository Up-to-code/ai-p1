# Validation / Domain / Onboarding

## Purpose
Shared backend validation namespace reserved for cross-cutting onboarding contracts that cannot belong to a single domain subfolder.
