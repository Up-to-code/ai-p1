# Validators / Domain / Invitations

## Purpose
Shared backend validators namespace reserved for cross-cutting invitations contracts that cannot belong to a single domain subfolder.
