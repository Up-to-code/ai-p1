# Validators / Domain / Integrations

## Purpose
Shared backend validators namespace reserved for cross-cutting integrations contracts that cannot belong to a single domain subfolder.
