# Validators / Domain / Organization

## Purpose
Shared backend validators namespace reserved for cross-cutting organization contracts that cannot belong to a single domain subfolder.
