# Validators / Domain / Permissions

## Purpose
Shared backend validators namespace reserved for cross-cutting permissions contracts that cannot belong to a single domain subfolder.
