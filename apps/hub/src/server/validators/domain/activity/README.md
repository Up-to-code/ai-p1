# Validators / Domain / Activity

## Purpose
Shared backend validators namespace reserved for cross-cutting activity contracts that cannot belong to a single domain subfolder.
