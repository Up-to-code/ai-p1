...
This area records accepted architecture decisions. Filenames are semantic
kebab-case; chronology is preserved in this index instead of numeric prefixes.
...
- Add new decisions with semantic lowercase kebab-case filenames.
- Keep status, context, decision, and consequences in each decision file.
- Update this index when a decision is added, superseded, or reopened.
- Do not reintroduce numeric filename prefixes.
