...
- `docs/adr/0001-partners-owns-partner-app-catalog-and-review.md`
- `docs/adr/0002-workspace-owns-organization-grants-and-oauth-runtime-projection.md`
- `apps/workspace/README.md`
- `apps/partners/README.md`
- `apps/demo-partner-app/README.md`
- `apps/workspace/docs/MCP_IMPLEMENTATION.md`
