...
2. [Setup and configuration](../operations/setup-and-configuration.md)
3. [Architecture](../architecture/system-architecture.md)
...
- `docs/operations/environment.md` for env changes.
- `docs/architecture/system-architecture.md` for cross-app flow changes.
