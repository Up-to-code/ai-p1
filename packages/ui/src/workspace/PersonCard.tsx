...
import type {
  ...
  WorkspacePersonCardType,
  WorkspacePersonRelation,
} from "./types";
...
export function brokerPresenceToPersonCard(broker: BrokerPresence) {
  return {
    id: broker.id,
    type: (broker.personType ?? "broker") as WorkspacePersonCardType,
    name: broker.name,
    title: broker.title,
