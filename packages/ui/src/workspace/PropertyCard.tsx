...
export type WorkspacePropertyCardContentProps = {
  image: string;
  title: string;
  location: string;
  priceLabel: string;
 ...
 */
export function WorkspacePropertyCardContent({
  image,
  title,
  location,
  priceLabel,
  ...
  publicationBadge,
  density = "compact",
}: WorkspacePropertyCardContentProps) {
  return (
    <article
      className={cn(
...
export default memo(WorkspacePropertyCardContent);
