...
export const mcpToolRegistry = [
  ...
  tool({ name: "tasks_create", title: "Create task", description: "Create a workspace task. Description accepts markdown for rich formatting.", resource: "task", action: "create", adapters: both }),
  tool({ name: "tasks_update", title: "Update task", description: "Update a workspace task. Description accepts markdown for rich formatting.", resource: "task", action: "update", adapters: both }),
