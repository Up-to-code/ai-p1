...
/**
 * WHY:   The current Qentrah project workflow relies on a rich, media-aware property form that is still tied to workspace adapters.
 * WHAT:  Exposes the existing Qentrah property form through the package `qentrah` entrypoint without forcing it into the generic core.
