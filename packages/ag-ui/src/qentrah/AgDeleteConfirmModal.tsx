...
/**
 * WHY:   The Qentrah workspace uses a strong destructive-action confirmation modal that should remain available through the package adapter entrypoint.
 * WHAT:  Renders the Qentrah-flavored delete confirmation modal with title, description, and confirm/cancel actions.
