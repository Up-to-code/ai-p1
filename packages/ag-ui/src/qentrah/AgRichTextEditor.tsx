...
/**
 * WHY:   The Qentrah project form needs a richer text input than a plain textarea while preserving the workspace visual language.
 * WHAT:  Provides the current contenteditable-based Qentrah rich text editor as an adapter export.
