...
Describe the user or operator outcome and link the tracking issue.

## Scope

List the domains, applications, or packages changed. Note any intentionally
deferred work.
...
Add screenshots, recordings, logs, or migration output when they help reviewers
validate the outcome. Remove sensitive information first.
